...
const locale = {
  ...
  'app.flow.repair.receipt.date.start': '开始收货日期',
  'app.flow.repair.receipt.date.end': '结束收货日期',
  ...
  'app.flow.repair.packingDelivery2': '包装发货',
  'app.repair.report.delete.img': '确定要删除这张照片吗?',

  'app.title': '赛来科技',
  'app.button.cancel': '返回',
  ...
  'menu.project.detail.serial': '工程编号',
  ...
  'menu.project.detail.closeDate.start': '开始完工日期',
  'menu.project.detail.closeDate.end': '结束完工日期',
  ...
  'menu.workOrder.workOrderList.query.processStatus.item4': '关闭',
  ...
  'menu.spare_parts.valve.serial2': '序列号/批次号',
  ...
  'permissionid.edit.project': '编辑工程',
  ...
  'maintenance.progress.report': '工程进度报表',
  'maintenance.status.report': '工程状态报表',
  'maintenance.working.hours.report': '工程工时报表',
