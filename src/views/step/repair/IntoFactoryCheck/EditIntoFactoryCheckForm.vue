          ...
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_nameplate_content_yesno', { } ]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-input v-decorator="[ 'intofc_nameplate_content_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_studs_nut_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_intofc_studs_nut_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_mounting_parts_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_mounting_parts_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_flange_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_flange_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_cracks_on_body_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_cracks_on_body_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_install_correct_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_install_correct_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_cracks_on_bonnet_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_cracks_on_bonnet_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_tubing_fittings_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_tubing_fittings_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_packing_bonnet_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_packing_bonnet_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_flow_direct_arrow_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_flow_direct_arrow_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_indicator_scale_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_indicator_scale_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">铭牌内容正确<br>Nameplate Correct</div>
                <a-radio-group v-decorator="['intofc_act_nameplate_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_nameplate_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">过滤器和减压阀<br>Filter & Regulator</div>
                <a-radio-group v-decorator="['intofc_other_filter_begulator_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_filter_begulator_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_safety_tag_attached_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_safety_tag_attached_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_solenoid_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_solenoid_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_vent_cap_attached_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_vent_cap_attached_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_transmitter_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_transmitter_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_bolts_nuts_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_bolts_nuts_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_ip_transducer_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_ip_transducer_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_cracks_on_yoke_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_cracks_on_yoke_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_limit_switch_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_limit_switch_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">气管及接头完好<br>Tubing/Fittings</div>
                <a-radio-group v-decorator="['intofc_act_tubing_fittings_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_tubing_fittings_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_lockup_trip_valve_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_lockup_trip_valve_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_handwheel_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_handwheel_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">旁路阀<br>Lockup/Trip Valve</div>
                <a-radio-group v-decorator="['intofc_other_bybass_valve_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_bybass_valve_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="4">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_act_stem_yoke_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_act_stem_yoke_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
          <a-col class="gutter-row" :span="4" :offset="2">
            <div class="gutter-box">
              <a-form-item>
                ...
                <a-radio-group v-decorator="['intofc_other_other_yesno', { }]">
                  <a-radio :value="1">
                    是
                  </a-radio>
                  <a-radio :value="2">
          ...
          <a-col class="gutter-row" :span="6">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_other_other_memo', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col class="gutter-row" :span="22">
            <div class="gutter-box">
              <a-form-item>
                <div class="linehight">备注<br>Remark</div>
                <a-input v-decorator="[ 'intofc_remark', {rules: []} ]" />
              </a-form-item>
            </div>
          </a-col>
        </a-row>
