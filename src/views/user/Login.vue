...
export default {
  ...
  methods: {
    ...
    handleSubmit (e) {
      ...
      const validateFieldsKey = customActiveKey === 'tab1' ? ['username', 'password', 'workOrderType'] : ['mobile', 'captcha']
    ...
    loginSuccess (res) {
      ...
      */
      ...
      setTimeout(() => {
        this.$notification.success({
          message: this.$t('app.login.welcome'),
          description: `${timeFix()}，欢迎回来`
        })
      }, 1000)
  ...
  mounted () {
    this.form.setFieldsValue({ workOrderType: '1' }, ['workOrderType'])
  }
}
</script>
